...
// e.g.: static_assert(TESTDB_MAX_DLC_VALUE <= APPLICATION_FRAME_DATA_SIZE, "Max DLC value in the
// driver is too big")
...
#define PC_VCU_VALIDATE_DLC(msgDlc) \
  (((msgDlc) <= (PC_VCU_MAX_DLC_VALUE)) ? (msgDlc) : (PC_VCU_MAX_DLC_VALUE))
