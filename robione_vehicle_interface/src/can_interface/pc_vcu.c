...
uint32_t Unpack_VCU_STAT_MOTION_SI_pc_vcu(
  VCU_STAT_MOTION_SI_t * _m, const uint8_t * _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->TireAngleRad_Act_ro =
    (int16_t)__ext_sig__((((_d[1] & (0xFFU)) << 8U) | (_d[0] & (0xFFU))), 16);
#ifdef PC_VCU_USE_SIGFLOAT
  _m->TireAngleRad_Act_phys =
    (sigfloat_t)(PC_VCU_TireAngleRad_Act_ro_fromS(_m->TireAngleRad_Act_ro));
#endif  // PC_VCU_USE_SIGFLOAT

  _m->VehicleSpeedMS_Act_ro =
    (int16_t)__ext_sig__((((_d[3] & (0xFFU)) << 8U) | (_d[2] & (0xFFU))), 16);
#ifdef PC_VCU_USE_SIGFLOAT
  _m->VehicleSpeedMS_Act_phys =
    (sigfloat_t)(PC_VCU_VehicleSpeedMS_Act_ro_fromS(_m->VehicleSpeedMS_Act_ro));
#endif  // PC_VCU_USE_SIGFLOAT
...
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_STAT_MOTION_SI_DLC);
       cframe->Data[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;

#ifdef PC_VCU_USE_SIGFLOAT
  _m->TireAngleRad_Act_ro = (int16_t)PC_VCU_TireAngleRad_Act_ro_toS(_m->TireAngleRad_Act_phys);
  _m->VehicleSpeedMS_Act_ro =
    (int16_t)PC_VCU_VehicleSpeedMS_Act_ro_toS(_m->VehicleSpeedMS_Act_phys);
#endif  // PC_VCU_USE_SIGFLOAT
...
uint32_t Pack_VCU_STAT_MOTION_SI_pc_vcu(
  VCU_STAT_MOTION_SI_t * _m, uint8_t * _d, uint8_t * _len, uint8_t * _ide)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_STAT_MOTION_SI_DLC); _d[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;
...
uint32_t Unpack_VCU_STAT_VEHICLE_STATE_pc_vcu(
  VCU_STAT_VEHICLE_STATE_t * _m, const uint8_t * _d, uint8_t dlc_)
{
  (void)dlc_;
...
uint32_t Pack_VCU_STAT_VEHICLE_STATE_pc_vcu(
  VCU_STAT_VEHICLE_STATE_t * _m, __CoderDbcCanFrame_t__ * cframe)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_STAT_VEHICLE_STATE_DLC);
       cframe->Data[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;

  cframe->Data[0] |= (uint8_t)((_m->GearAct & (0x0FU)) | ((_m->Reserved & (0x0FU)) << 4U));
  cframe->Data[1] |=
    (uint8_t)((_m->TurnLeft_Stat & (0x01U)) | ((_m->TurnRight_Stat & (0x01U)) << 1U) |
              ((_m->Hazard_Stat & (0x01U)) << 2U) | ((_m->Horn_Stat & (0x01U)) << 3U) |
              ((_m->Reserved_1 & (0x0FU)) << 4U));
...
uint32_t Pack_VCU_STAT_VEHICLE_STATE_pc_vcu(
  VCU_STAT_VEHICLE_STATE_t * _m, uint8_t * _d, uint8_t * _len, uint8_t * _ide)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_STAT_VEHICLE_STATE_DLC);
       _d[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;

  _d[0] |= (uint8_t)((_m->GearAct & (0x0FU)) | ((_m->Reserved & (0x0FU)) << 4U));
  _d[1] |= (uint8_t)((_m->TurnLeft_Stat & (0x01U)) | ((_m->TurnRight_Stat & (0x01U)) << 1U) |
                     ((_m->Hazard_Stat & (0x01U)) << 2U) | ((_m->Horn_Stat & (0x01U)) << 3U) |
                     ((_m->Reserved_1 & (0x0FU)) << 4U));
...
{
  (void)dlc_;
  _m->TireAngleRad_Cmd_ro =
    (int16_t)__ext_sig__((((_d[1] & (0xFFU)) << 8U) | (_d[0] & (0xFFU))), 16);
#ifdef PC_VCU_USE_SIGFLOAT
  _m->TireAngleRad_Cmd_phys =
    (sigfloat_t)(PC_VCU_TireAngleRad_Cmd_ro_fromS(_m->TireAngleRad_Cmd_ro));
#endif  // PC_VCU_USE_SIGFLOAT

  _m->VehicleSpeedMS_Cmd_ro =
    (int16_t)__ext_sig__((((_d[3] & (0xFFU)) << 8U) | (_d[2] & (0xFFU))), 16);
#ifdef PC_VCU_USE_SIGFLOAT
  _m->VehicleSpeedMS_Cmd_phys =
    (sigfloat_t)(PC_VCU_VehicleSpeedMS_Cmd_ro_fromS(_m->VehicleSpeedMS_Cmd_ro));
#endif  // PC_VCU_USE_SIGFLOAT
...
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_CTRL_CMD_SI_DLC);
       cframe->Data[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;
  ...
  _m->VehicleSpeedMS_Cmd_ro =
    (int16_t)PC_VCU_VehicleSpeedMS_Cmd_ro_toS(_m->VehicleSpeedMS_Cmd_phys);
#endif  // PC_VCU_USE_SIGFLOAT
  ...
  cframe->Data[4] |=
    (uint8_t)((_m->AutonomousEnable & (0x01U)) | ((_m->EmergencyActive & (0x01U)) << 1U) |
              ((_m->SafetyDisable & (0x01U)) << 2U) | ((_m->GearReq & (0x1FU)) << 3U));
  cframe->Data[5] |= (uint8_t)((_m->TurnLeft & (0x01U)) | ((_m->TurnRight & (0x01U)) << 1U) |
                               ((_m->Hazard & (0x01U)) << 2U) | ((_m->Horn & (0x01U)) << 3U) |
                               ((_m->Reserved & (0x0FU)) << 4U));
  cframe->Data[6] |= (uint8_t)((_m->AliveCounter & (0xFFU)));
  cframe->Data[7] |= (uint8_t)((_m->CRC8 & (0xFFU)));
...
uint32_t Pack_VCU_CTRL_CMD_SI_pc_vcu(
  VCU_CTRL_CMD_SI_t * _m, uint8_t * _d, uint8_t * _len, uint8_t * _ide)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(VCU_CTRL_CMD_SI_DLC); _d[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;
  ...
  _d[4] |= (uint8_t)((_m->AutonomousEnable & (0x01U)) | ((_m->EmergencyActive & (0x01U)) << 1U) |
                     ((_m->SafetyDisable & (0x01U)) << 2U) | ((_m->GearReq & (0x1FU)) << 3U));
  _d[5] |= (uint8_t)((_m->TurnLeft & (0x01U)) | ((_m->TurnRight & (0x01U)) << 1U) |
                     ((_m->Hazard & (0x01U)) << 2U) | ((_m->Horn & (0x01U)) << 3U) |
                     ((_m->Reserved & (0x0FU)) << 4U));
  _d[6] |= (uint8_t)((_m->AliveCounter & (0xFFU)));
  _d[7] |= (uint8_t)((_m->CRC8 & (0xFFU)));
...
uint32_t Unpack_SAFE_STAT_ROS2_HEARTBEAT_pc_vcu(
  SAFE_STAT_ROS2_HEARTBEAT_t * _m, const uint8_t * _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ROS_Time_ms =
    (uint64_t)(((uint64_t)(_d[5] & (0xFFU)) << 40U) | ((uint64_t)(_d[4] & (0xFFU)) << 32U) |
               ((_d[3] & (0xFFU)) << 24U) | ((_d[2] & (0xFFU)) << 16U) | ((_d[1] & (0xFFU)) << 8U) |
               (_d[0] & (0xFFU)));
  _m->AliveCounter = (uint8_t)((_d[6] & (0xFFU)));
  _m->CRC8 = (uint8_t)((_d[7] & (0xFFU)));
...
uint32_t Pack_SAFE_STAT_ROS2_HEARTBEAT_pc_vcu(
  SAFE_STAT_ROS2_HEARTBEAT_t * _m, __CoderDbcCanFrame_t__ * cframe)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(SAFE_STAT_ROS2_HEARTBEAT_DLC);
       cframe->Data[i++] = PC_VCU_INITIAL_BYTE_VALUE)
    ;
...
uint32_t Pack_SAFE_STAT_ROS2_HEARTBEAT_pc_vcu(
  SAFE_STAT_ROS2_HEARTBEAT_t * _m, uint8_t * _d, uint8_t * _len, uint8_t * _ide)
{
  uint8_t i;
  for (i = 0u; i < PC_VCU_VALIDATE_DLC(SAFE_STAT_ROS2_HEARTBEAT_DLC);
       _d[i++] = PC_VCU_INITIAL_BYTE_VALUE)
